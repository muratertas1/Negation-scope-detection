...
def extract_features(sentence):
    ...
    for i in range(len(sentence)):
        ...
        features = {
            ...
            'dependency_label': dependency_type,
...
def write_predictions_to_file(original_file_path, sentences_with_predictions, output_file_path):
    ...
    """
    columns = ['doc_id', 'sentence_num', 'token_num', 'token', 'lemma', 'pos', 'constituency', 'cue', 'label', 'focus', 'constituency_distance', 'same_clause', 'same_phrase', 'is_punct', 'sentence_position', 'is_negation_cue', 'token_distance', 'dependency_label', 'dependency_head', 'distance_to_root', 'distance_to_cue']
...
output_file_path = 'data/crf_dev_output_dep_features.tsv'
...
write_predictions_to_file(dev_file_path, y_pred, output_file_path)
